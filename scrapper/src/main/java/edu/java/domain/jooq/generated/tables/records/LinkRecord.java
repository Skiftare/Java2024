...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@NotNull Long value1, @NotNull String value2, @Nullable OffsetDateTime value3, @NotNull OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@NotNull Long linkId, @NotNull String url, @Nullable OffsetDateTime createdAt, @NotNull OffsetDateTime lastUpdateAt) {
        super(Link.LINK);
